...
var (
	managementConsoleUrl  = flag.String("mgmt-console-url", "", "Toae Management Console URL")
	managementConsolePort = flag.Int("mgmt-console-port", 443, "Toae Management Console Port")
